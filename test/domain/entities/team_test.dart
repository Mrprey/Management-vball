...
void main() {
  group('Team', () {
    ...
    setUp(() {
      players = [
        Player(id: 'player-1', name: 'John Doe', number: 10, position: 'Setter'),
        Player(id: 'player-2', name: 'Jane Smith', number: 5, position: 'Libero'),
      ];
    });
    ...
    test('addPlayer should create a new team with an additional player', () {
      final team = Team(id: 'team-1', name: 'Eagles', players: players);
      final newPlayer = Player(id: 'player-3', name: 'Bob Jones', number: 7, position: 'Middle');
